...
# Projeto Especial - AI SQL Query Generator Text-to-SQL
...
def main():
    ...
    st.set_page_config(page_title="Data Science", page_icon=":100:", layout="wide")
    ...
    with st.sidebar:
        ...
        if st.button("Suporte"):
            st.write("Dúvidas? Envie um e-mail para: takeyasumarcus@mgail.com")
